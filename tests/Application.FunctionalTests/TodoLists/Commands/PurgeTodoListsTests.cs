using OpenPassword.Application.Common.Exceptions;
using OpenPassword.Application.Common.Security;
using OpenPassword.Application.TodoLists.Commands.CreateTodoList;
using OpenPassword.Application.TodoLists.Commands.PurgeTodoLists;
using OpenPassword.Domain.Entities;

namespace OpenPassword.Application.FunctionalTests.TodoLists.Commands;
